...
1. Available Quota for: `text-embedding-ada-002`, and `gpt-4`
...
- Azure OpenAI - Standard tier, GPT-4 and Ada models. [See Pricing](https://azure.microsoft.com/pricing/details/cognitive-services/openai-service/)
